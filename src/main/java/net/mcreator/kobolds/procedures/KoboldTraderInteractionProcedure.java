	...
	public static void execute(Map<String, Object> dependencies) {
		...
		if (EntityTypeTags.getAllTags().getTagOrEmpty(new ResourceLocation("kobolds:trader")).contains(entity.getType())
			...
			new Object() {
				...
				private void run() {
					if (entity.getPersistentData().getDouble("TimerApple") == 0 && !world.getEntitiesOfClass(Bat.class,
							AABB.ofSize(new Vec3((entity.getX()), (entity.getY()), (entity.getZ())), 5, 5, 5), e -> true).isEmpty()) {
						if (entity instanceof LivingEntity _entity) {
							ItemStack _setstack = (ItemStack.EMPTY);
							_setstack.setCount(1);
							_entity.setItemInHand(InteractionHand.OFF_HAND, _setstack);
		...
		if (EntityTypeTags.getAllTags().getTagOrEmpty(new ResourceLocation("kobolds:koboldz")).contains(entity.getType())
