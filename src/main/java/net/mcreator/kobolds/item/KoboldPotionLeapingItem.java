...
import net.mcreator.kobolds.procedures.KoboldPotionLeapProcedure;
...
public class KoboldPotionLeapingItem extends MilkBucketItem {
	public KoboldPotionLeapingItem() {
		...
		setRegistryName("kobold_potion_leaping");
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A79Jump Boost (1:00) & Slow Falling (1:00)"));
	}
